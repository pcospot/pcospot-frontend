...
import ImagePreview from "./chatFunction/ImagePreview.tsx";
    ...
    return (
        <div className="chatInput-container">
            <Modal width="calc(95vw - 544px)" height={200} onOpen={isModalOpen} onClose={() => setIsModalOpen(false)} className="chatInput-modal">
                <ImagePreview height="100%" src={file}/>
            </Modal>
            ...
            <div className="chatInput-function" style={isModalOpen ? {borderTopLeftRadius : '0px', borderTopRightRadius : "0px"} : {}}>
